...
export async function getDocument(document_id) {
	...
	SELECT document_id, cord_uid, pubmed_id, title, abstract, url, journal, publish_year, doi, altmetric_id, altmetric_score, altmetric_score_1day, altmetric_score_1week, altmetric_openaccess, altmetric_badgetype FROM documents d
