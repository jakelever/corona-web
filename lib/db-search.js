...
export async function searchTitleAbstracts(query) {
	...
	const selectSQL = escape`SELECT d.document_id, d.cord_uid, d.pubmed_id, d.title, d.url, d.journal, d.is_preprint, d.publish_year, d.publish_month, d.publish_day, d.doi, d.altmetric_id, d.altmetric_score, d.altmetric_score_1day, d.altmetric_score_1week, d.altmetric_openaccess, d.altmetric_badgetype `.append(partialSQL)
